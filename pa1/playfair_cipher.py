# https://www.techconductor.com/algorithms/python/Ciphers/playfair_cipher.php
...
class PlayfairCipher:
    ...
    def prepare_input(self, dirty):
        """Separate repeated letters with X's."""
        
        dirty = ''.join([c for c in dirty if c in string.ascii_letters])
    ...
    def encrypt(self, plaintext):
        table = self.generate_table(self.key)
...
if __name__ == "__main__":
    ...
    print(cipher.encrypt("weareattacked"))